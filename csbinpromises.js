...
async function handle() {
    const data1 = await fetch("https://api.github.com/users/DevRamona");
...
async function newHandle() {
    try {
        ...
        const p4 = await p3.json()
        const p5 = await fetch("https://jsonplaceholder.typicode.com/albums")
        const p6 = await p5.json();
        
    Promise.all([p2, p4, p6]);
    console.log("First p1", p2);
console.log("First p2", p4);
console.log("First p3", p6);
